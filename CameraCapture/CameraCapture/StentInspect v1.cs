...
namespace CameraCapture
{
    public partial class CameraCapture : Form
    {
        ...
        int ycountmax = 10; //Steps per rotation
        ...
        private string X_inc()
        {
            ...
            string SerialReplyx = serialPort1.ReadTo("$");
            serialPort1.Close();
        ...
        private string Y_inc()
        {
            ...
            string SerialReplyy = serialPort1.ReadTo("$");
            serialPort1.Close();
        ...
        {   //Here the complete process is runs
            ...
            for (int xcount = 1; xcount < xcountmax+1; xcount++)
            {
                for (int ycount = 1; ycount < ycountmax+1; ycount++)
                {
                    ...
                    //DialogResult dialogresult = MessageBox.Show("xcount:" + xcount + "   yxount: " + ycount, "", MessageBoxButtons.YesNo);
