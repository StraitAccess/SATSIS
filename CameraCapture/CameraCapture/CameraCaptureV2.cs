...
namespace CameraCapture
{
    public partial class CameraCapture : Form
    {
        ...
        int ycountmax = 32; //Steps per rotation
        int xcountmax = 2;  //Steps per linear feed
        ...
        {   //Here the complete process is run. Y for 320 step, X for 1 step, Y for 320 steps
            ...
            for (xcount = 1; xcount <= xcountmax; xcount++)
            {
                for (ycount = 1; ycount <= ycountmax; ycount++)
                {
                    ...
                    //new method
                    //Image<Gray, Byte> frame1 = capture.QueryFrame().ToImage<Gray, Byte>(); //For Gray image
                    ...
                    //Resize the photo for display purposes only
                    frame1 = frame1.Resize(150, 100, Emgu.CV.CvEnum.Inter.Cubic);
                    Camimagebox3.Image = frame1;
                    ...
                    //string scurr = currentstep.ToString();
